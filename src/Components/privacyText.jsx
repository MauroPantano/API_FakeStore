...
const privacyText = () => {
  ...
  return (
    <div style={{paddingLeft: 10}}>
        ...
        <li>Per esercitare questi diritti, si prega di contattarci tramite le informazioni di contatto sotto.</li>
        ...
        Per qualsiasi questione correlata ai diritti individuali o alle informazioni personali, può inviare un'email a maurizio96010@gmail.com.
    </div>
  )
}
